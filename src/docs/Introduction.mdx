...
This UI library contains a number of React elements for use on other projects, this also generates a LLM config file that knows how to use the library.
...
<a href="./model-config.json" target="_blank" rel="noreferrer">
  {" "}
