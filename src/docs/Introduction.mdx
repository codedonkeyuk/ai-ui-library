...
**WARNING** If you have multiple component libnraries and dont have a ton of memory, I recomend using one component library per LLM. Then load the LLM you need per project. Its much simpler!

## Modelfile

<a href="./Modelfile" target="_blank" rel="noreferrer">
  {" "}
